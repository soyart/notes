...
- Nix is a group of systems revolving around the (1) reproducibility and (2) Nix package manager
- Different parts of the Nix project could be used:
	- NixOS for our VPS OS
	- nix-shell for interactive shells
	- Nix flake for packaging and distributing other software
	- `nix` the package manager for building some software
	- Nix tools as build systems in CICD
- Nix is also the name of the project's [programming language]([[Nix (language)]]), a functional domain specific language for composing Nix expressions
- # [[Nix cheat sheet]]
- # Why Nix?
	- ## Direct benefits
	...
	- ## Abstraction
		- You can express your entire systems in Nix expressions alone
	...
	- ## Support
		- Nix is on Linux and macOS, and the hardware support is amazing
...
- # [[Nix (language)]]
	- Nix is built around Nix language, which is like a functional JSONNET
- # [[nix-shell]]
